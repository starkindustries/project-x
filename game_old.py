...
equipped_item = ""
player_did_action = False

gamemap = [[] for x in range(24)]
...
def take_inputs():
    ...
    if keyboard.is_pressed('1'):
        if equipped_item == "Hoe":
            equipped_item = ""
        else:
            equipped_item = "Hoe"
    if keyboard.is_pressed("space"):
        print("Use equipped item", player_x, player_y)
        player_did_action = True
        # level_y[player_y][player_x] = "t"
        # assume hoe is equipped and till soil
...
def replace():
    ...
    which_last_y[last_x] = level_y[player_y][player_x]
    ...
    row_1[73] = score
    row_2[73] = lives
    # print("EQUPPED ITEM", equipped_item)
    # if equipped_item == "Hoe":
    #     print("HELLOOOO WORLD")
    row_3[73] = "*" if equipped_item == "Hoe" else ""
